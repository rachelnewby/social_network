...
posts, title, content, number_of_views, user_account
```
...
| Record                | Properties          |
| --------------------- | ------------------  |
| user_accounts         | email address, username
| posts                 | title, content, number_of_views, user_account_id
...
1. Can one user accounts have many posts? Yes
